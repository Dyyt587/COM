...
/**
  * @brief This function handles BDMA2 channel3 global interrupt.
  */
void BDMA2_Channel3_IRQHandler(void)
{
  /* USER CODE BEGIN BDMA2_Channel3_IRQn 0 */

  /* USER CODE END BDMA2_Channel3_IRQn 0 */
  HAL_DMA_IRQHandler(&hdma_spi6_tx);
  /* USER CODE BEGIN BDMA2_Channel3_IRQn 1 */

  /* USER CODE END BDMA2_Channel3_IRQn 1 */
}
